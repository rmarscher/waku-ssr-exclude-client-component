...
function requireReactServerDomWebpackServer_edge_production() {
  ...
  globalThis.__WAKU_SERVER_MODULE_LOADING__ ||= /* @__PURE__ */ new Map();
  globalThis.__WAKU_SERVER_MODULE_CACHE__ ||= /* @__PURE__ */ new Map();
  globalThis.__WAKU_SERVER_CHUNK_LOAD__ ||= (id) => {
    if (!globalThis.__WAKU_SERVER_MODULE_LOADING__.has(id)) {
      globalThis.__WAKU_SERVER_MODULE_LOADING__.set(
        id,
        globalThis.__WAKU_SERVER_IMPORT__(id).then((m) => {
  ...
  globalThis.__WAKU_SERVER_REQUIRE__ ||= (id) => globalThis.__WAKU_SERVER_MODULE_CACHE__.get(id);
