import { r as requireReactDom } from "./index-Pm7HIP5V.js";
...
function requireReactServerDomWebpackClient_edge_production() {
  ...
  var ReactDOM = requireReactDom(), decoderOptions = { stream: true };
  ...
  globalThis.__WAKU_CLIENT_MODULE_LOADING__ ||= /* @__PURE__ */ new Map();
  globalThis.__WAKU_CLIENT_MODULE_CACHE__ ||= /* @__PURE__ */ new Map();
  globalThis.__WAKU_CLIENT_CHUNK_LOAD__ ||= (id) => {
    if (!globalThis.__WAKU_CLIENT_MODULE_LOADING__.has(id)) {
      globalThis.__WAKU_CLIENT_MODULE_LOADING__.set(
        id,
        globalThis.__WAKU_CLIENT_IMPORT__(id).then((m) => {
  ...
  globalThis.__WAKU_CLIENT_REQUIRE__ ||= (id) => globalThis.__WAKU_CLIENT_MODULE_CACHE__.get(id);
...
export {
  requireReactServerDomWebpackClient_edge_production as r
};
